...
//    }
    ...
    public static transport_vehicle createVehicle(String mark, int len, transport_vehicle tv)
    {
        try
        {
            Class clsTV = tv.getClass();
//            System.out.println(clsTV);
            Constructor constr = clsTV.getConstructor(String.class, Integer.TYPE);
//            System.out.println(constr);
            transport_vehicle vehicle = (transport_vehicle) constr.newInstance(mark, len);
            return vehicle;
        }
        catch (Exception e)
        {
